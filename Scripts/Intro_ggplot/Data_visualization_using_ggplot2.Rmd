...
Some of the materials originate in the [Introduction to ggplot2](https://ggplot2.tidyverse.org/articles/ggplot2.html) with some of the text copied with a few edits.

This tutorial introduces ggplot2 along with other plotting techniques, providing a comprehensive guide to creating visually appealing and informative graphics.

## **Introduction to ggplot2**

ggplot2 is an R package for producing visualizations of data. More complete information about how to use ggplot2 can be found in the [book](https://ggplot2-book.org/), but here you’ll find a brief overview of the plot components. For structure, we go over the 7 composable parts that come together as a set of instructions on how to draw a chart.

The 7 composable parts are Theme, Coordinates, Facets, Scales, Layers, Mapping and Data. Out of these components, ggplot2 needs at least the following three to produce a chart: data, a mapping, and a layer. The scales, facets, coordinates, and themes have sensible defaults that take away a lot of finicky work. Here, we will be discussing the commonly used parts while leaving the rest for you to investigate.
